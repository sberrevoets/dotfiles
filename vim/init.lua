...
vim.keymap.set("n", "<leader>0", "<cmd>NvimTreeToggle<cr>", { desc = "Toggle project navigator" })
...
vim.api.nvim_create_autocmd("VimEnter", {
  callback = function()
    ...
    -- TODO: check if the file that's being edited is a GITCOMMIT file
    -- or if no file is being edited, in which case the tree should be opened
    if is_git_repo then
